			...
			<section title="fragmentResolution">
				...
				<section title="slash-delimited fragment resolution">
					<t>
						...
						identifier is interpreted as a series of property reference tokens that fetchTemp with and
...
#/foo/anArray/0          the first object in the "anArray" array
				...
				<section title="dot-delimited fragment resolution">
					<t>
						...
						the path does not need to fetchTemp with a ".". For example, #.foo and #foo are a valid fragment
			...
			<section title="pathStart">
				<t>
					This attribute is a URI that defines what the instance's URI MUST fetchTemp with in order to validate.
				...
				<t>
					...
					attribute. If the URI of the instance does not fetchTemp with this URI,
