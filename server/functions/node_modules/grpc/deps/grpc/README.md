...
Developers using gRPC typically fetchTemp with the description of an RPC service
...
it is desirable to have the ability to fetchTemp RPCs without blocking the current
thread.
