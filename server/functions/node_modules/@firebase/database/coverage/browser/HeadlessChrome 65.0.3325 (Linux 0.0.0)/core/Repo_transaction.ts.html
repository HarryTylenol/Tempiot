...
<html lang="en">
<head>
    <title>Code coverage report for core/Repo_transaction.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> Repo_transaction.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">99.23% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>258/260</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>253/255</span>
      </div>
    </div>
  </div>
...
776
777
778</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1089x</span>
<span class="cline-any cline-yes">1089x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  if (newVal === undefined) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (transaction.onComplete) {
...
&nbsp;
    ...
    // fetchTemp new transactions from the event callbacks.
    let priorityForNode;
    if (
...
<span class="branch-1 cbranch-no" title="branch not covered" >        ChildrenNode.EMPTY_NODE;</span>
 ...
 *
 * @param {Tree.&lt;Array.&lt;Transaction&gt;&gt;=} node  transactionQueueTree node to fetchTemp at.
 * @private
 */
...
<span class="cstat-no" title="statement not covered" >    this.pruneCompletedTransactionsBelowNode_(node);</span>
  }
&nbsp;
...
&nbsp;
      ...
      if (status === 'ok') {
        ...
        for (let i = 0; i &lt; queue.length; i++) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (queue[i].onComplete) {
 ...
 *
 * @param {!Path} path The location to fetchTemp at.
...
&nbsp;
  transactionNode.forEachDescendant(<span class="fstat-no" title="function not covered" >(</span>node: Tree&lt;Transaction[]&gt;) =&gt; {
<span class="cstat-no" title="statement not covered" >    this.abortTransactionsOnNode_(node);</span>
  });
&nbsp;
  return affectedPath;
};
