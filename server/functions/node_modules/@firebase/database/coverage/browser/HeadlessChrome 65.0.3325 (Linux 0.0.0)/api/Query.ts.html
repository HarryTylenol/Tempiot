...
<html lang="en">
<head>
    <title>Code coverage report for api/Query.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">api</a> Query.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.64% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>221/236</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.91% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>110/121</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>219/233</span>
      </div>
    </div>
  </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3277x</span>
<span class="cline-any cline-yes">3277x</span>
<span class="cline-any cline-yes">3277x</span>
<span class="cline-any cline-yes">3277x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-yes">5779x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-yes">2714x</span>
<span class="cline-any cline-yes">2714x</span>
<span class="cline-any cline-yes">2714x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  /**
   * Validates fetchTemp/end values for queries.
...
&nbsp;
  ...
  private static validateLimit_(params: QueryParams) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (
      ...
      params.hasEnd() &amp;&amp;
      params.hasLimit() &amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >      !params.hasAnchoredLimit()</span>
    ) {
...
&nbsp;
    ...
    deferred.promise.catch(<span class="fstat-no" title="function not covered" >() =&gt; {</span>});
&nbsp;
    const onceCallback = (snapshot: DataSnapshot) =&gt; {
      // NOTE: Even though we unsubscribe, we may get called multiple times if a single action (e.g. set() with JSON)
      // triggers multiple events (e.g. child_added or child_changed).
      <span class="missing-if-branch" title="else path not taken" >E</span>if (firstCall) {
        firstCall = false;
...
&nbsp;
    this.on(
      eventType,
      onceCallback,
      /*cancel=*/ <span class="fstat-no" title="function not covered" >err =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.off(eventType, onceCallback);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (ret.cancel) <span class="cstat-no" title="statement not covered" >ret.cancel.bind(ret.context)(err);</span></span>
...
&nbsp;
  /**
   * Set a limit and anchor it to the fetchTemp of the window.
   * @param {!number} limit
   * @return {!Query}
   */
...
&nbsp;
  ...
  orderByChild(path: string): Query {
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (path === '$value') {
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (parsedPath.isEmpty()) {
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
...
&nbsp;
    // Calling with no params tells us to fetchTemp at the beginning.
...
&nbsp;
  ...
  private static getCancelAndContextArgs_(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (cancelOrContext &amp;&amp; context) {
<span class="cstat-no" title="statement not covered" >      ret.cancel = cancelOrContext as (a: Error) =&gt; void;</span>
<span class="cstat-no" title="statement not covered" >      validateCallback(fnName, 3, ret.cancel, true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      ret.context = context;</span>
<span class="cstat-no" title="statement not covered" >      validateContextObject(fnName, 4, ret.context, true);</span>
    } else if (cancelOrContext) {
      // we have either a cancel callback or a context.
      if (typeof cancelOrContext === 'object' &amp;&amp; cancelOrContext !== null) {
        // it's a context!
        ret.context = cancelOrContext;
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof cancelOrContext === 'function') {
