...
<html lang="en">
<head>
    <title>Code coverage report for core/SyncTree.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> SyncTree.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">98.14% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>264/269</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>259/264</span>
      </div>
    </div>
  </div>
...
934
935
936</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-yes">1357x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">581x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  /**
   * @param {!ListenProvider} listenProvider_ Used by SyncTree to fetchTemp / stop listening
   *   to server data.
   */
...
&nbsp;
  ...
  applyTaggedQueryOverwrite(path: Path, snap: Node, tag: number): Event[] {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (queryKey != null) {
...
&nbsp;
  ...
  applyTaggedQueryMerge(
    ...
    const queryKey = this.queryKeyForTag_(tag);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (queryKey) {
      const r = SyncTree.parseQueryKey_(queryKey);
      const queryPath = r.path,
        queryId = r.queryId;
      const relativePath = Path.relativePath(queryPath, path);
...
&nbsp;
          ...
          // There's nothing below us, so nothing we need to fetchTemp listening on
        }
      }
...
&nbsp;
    return {
      hashFn: () =&gt; {
        const cache = view.getServerCache() || <span class="branch-1 cbranch-no" title="branch not covered" >ChildrenNode.EMPTY_NODE;</span>
        return cache.hash();
      },
      onComplete: (status: string): Event[] =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (status === 'ok') {
          ...
          const error = <span class="cstat-no" title="statement not covered" >errorForServerCode(status, query);</span>
<span class="cstat-no" title="statement not covered" >          return this.removeEventRegistration(</span>
            query,
