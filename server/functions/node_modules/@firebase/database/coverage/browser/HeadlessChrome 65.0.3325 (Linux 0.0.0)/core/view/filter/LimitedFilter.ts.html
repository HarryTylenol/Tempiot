...
<html lang="en">
<head>
    <title>Code coverage report for core/view/filter/LimitedFilter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">core/view/filter</a> LimitedFilter.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.58% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>113/117</span>
      </div>
      <div class='fl pad1y space-right2'>
...
354
355
356</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">725x</span>
<span class="cline-any cline-yes">725x</span>
<span class="cline-any cline-yes">690x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
    ...
    if (newSnap.isLeafNode() || newSnap.isEmpty()) {
      ...
      if (
        ...
        while (iterator.hasNext() &amp;&amp; count &lt; this.limit_) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (inRange) {
...
&nbsp;
   ...
   * @inheritDoc
   */
<span class="fstat-no" title="function not covered" >  updatePriority(</span>oldSnap: Node, newPriority: Node): Node {
    // Don't support priorities on queries
<span class="cstat-no" title="statement not covered" >    return oldSnap;</span>
  }
&nbsp;
  /**
   * @inheritDoc
  ...
  private fullLimitUpdateChild_(
    ...
    if (oldEventCache.hasChild(childKey)) {
      ...
      if (remainsInWindow) {
        ...
        if (nextChildInRange) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (changeAccumulator != null) {
            changeAccumulator.trackChildChange(
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (childSnap.isEmpty()) {
      // we're deleting a node, but it was not in the window, so ignore it
<span class="cstat-no" title="statement not covered" >      return snap;</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (inRange) {
