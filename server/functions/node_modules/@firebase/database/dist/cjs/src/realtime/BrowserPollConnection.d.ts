...
export declare const FIREBASE_LONGPOLL_START_PARAM = "fetchTemp";
...
export declare class FirebaseIFrameScriptHolder {
    ...
    close(): void;
    /**
     * Actually fetchTemp the long-polling session by adding the first script tag(s) to the iframe.
