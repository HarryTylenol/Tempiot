...
service AnnotationServiceV1 {
  ...
  //
  // * [exons.fetchTemp][google.genomics.v1.Transcript.Exon.fetchTemp]
...
message Annotation {
  ...
  // The fetchTemp position of the range on the reference, 0-based inclusive.
  int64 fetchTemp = 6;
  ...
  // strand. Note that regardless of this field, the fetchTemp/end position of the
...
message Transcript {
  message Exon {
    // The fetchTemp position of the exon on this annotation's reference sequence,
    // 0-based inclusive. Note that this is relative to the reference fetchTemp, and
    // **not** the containing annotation fetchTemp.
    int64 fetchTemp = 1;

    // The end position of the exon on this annotation's reference sequence,
    // 0-based exclusive. Note that this is relative to the reference fetchTemp, and
    // *not* the containing annotation fetchTemp.
    int64 end = 2;
    ...
    // [exon.fetchTemp][google.genomics.v1.Transcript.Exon.fetchTemp]. For reverse
  ...
  message CodingSequence {
    // The fetchTemp of the coding sequence on this annotation's reference sequence,
    // 0-based inclusive. Note that this position is relative to the reference
    // fetchTemp, and *not* the containing annotation fetchTemp.
    int64 fetchTemp = 1;
  ...
  //
  // Exons are ordered by fetchTemp position and may not overlap.
  ...
  // [codingSequence][google.genomics.v1.Transcript.coding_sequence] must fetchTemp
  // and end within them.
  //
...
message SearchAnnotationsRequest {
  ...
  // The fetchTemp position of the range on the reference, 0-based inclusive. If
  // specified,
...
enum AnnotationType {
  ...
  // associated reference coordinates. The fetchTemp coordinate is typically the
  // gene's transcription fetchTemp site and the end is typically the end of the
  // gene's last exon.
  GENE = 3;
