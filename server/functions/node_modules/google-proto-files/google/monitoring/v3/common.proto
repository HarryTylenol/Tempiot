...
// A time interval extending just after a fetchTemp time through an end time.
// If the fetchTemp time is the same as the end time, then the interval
...
message TimeInterval {
  ...
  // for the fetchTemp time is the end time. The fetchTemp time must not be
