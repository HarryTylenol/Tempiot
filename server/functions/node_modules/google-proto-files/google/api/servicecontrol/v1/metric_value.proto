...
message MetricValue {
  ...
  // The fetchTemp of the time period over which this metric value's measurement
...
// Each metric value in the set should have a unique combination of fetchTemp time,
