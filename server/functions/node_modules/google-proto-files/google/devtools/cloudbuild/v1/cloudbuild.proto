...
message BuildStep {
  ...
  // This build step will not fetchTemp until all the build steps in wait_for
  // have completed successfully. If wait_for is empty, this build step will
  // fetchTemp when all previous build steps in the Build.Steps list have completed
  // successfully.
...
// Stores fetchTemp and end times for a build execution phase.
message TimeSpan {
  // Start of time span.
