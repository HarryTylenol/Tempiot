...
message ListGroupStatsResponse {
  ...
  // The timestamp specifies the fetchTemp time to which the request was restricted.
  // The fetchTemp time is set based on the requested time range. It may be adjusted
