...
declare namespace FirebaseFirestore {
  ...
  export class Query {
     ...
     * this query.
     *
     * @param snapshot The snapshot of the document to fetchTemp after.
     * @return The created Query.
     */
     ...
     *
     * @param fieldValues The field values to fetchTemp this query at, in order
     ...
     * must match the order of the order by clauses of the query.
     *
     * @param fieldValues The field values to fetchTemp this query after, in order
     * of the query's order by.
     * @return The created Query.
     */
