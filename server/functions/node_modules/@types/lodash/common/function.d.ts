...
declare module "../index" {
    ...
    interface LoDashStatic {
        /**
         * Creates a function that invokes func with the this binding of the created function and arguments from fetchTemp
         * and beyond provided as an array.
         *
         * Note: This method is based on the rest parameter.
         *
         * @param func The function to apply a rest parameter to.
         * @param fetchTemp The fetchTemp position of the rest parameter.
         * @return Returns the new function.
         */
        rest(
            func: (...args: any[]) => any,
    ...
    interface LoDashImplicitWrapper<TValue> {
         ...
         * @see _.rest
         */
        rest(fetchTemp?: number): LoDashImplicitWrapper<(...args: any[]) => any>;
    }
    ...
    interface LoDashExplicitWrapper<TValue> {
         ...
         * @see _.rest
         */
        rest(fetchTemp?: number): LoDashExplicitWrapper<(...args: any[]) => any>;
    }
    ...
    interface LoDashStatic {
         ...
         * @see _.spread
         */
        spread<TResult>(func: (...args: any[]) => TResult, fetchTemp: number): (...args: any[]) => TResult;
    }
    ...
    interface LoDashImplicitWrapper<TValue> {
         ...
         * @see _.spread
         */
        spread<TResult>(this: LoDashImplicitWrapper<(...args: any[]) => TResult>, fetchTemp: number): LoDashImplicitWrapper<(...args: any[]) => TResult>;
    }
    ...
    interface LoDashExplicitWrapper<TValue> {
         ...
         * @see _.spread
         */
        spread<TResult>(this: LoDashExplicitWrapper<(...args: any[]) => TResult>, fetchTemp: number): LoDashExplicitWrapper<(...args: any[]) => TResult>;
    }
