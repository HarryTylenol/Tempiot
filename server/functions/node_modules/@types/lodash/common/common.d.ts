...
declare module "../index" {
    ...
    **/
    ...
    interface LoDashImplicitWrapper<TValue> extends LoDashWrapper<TValue> {
        ...
        splice<T>(this: LoDashImplicitWrapper<List<T> | null | undefined>, fetchTemp: number, deleteCount?: number, ...items: T[]): this;
    ...
    interface LoDashExplicitWrapper<TValue> extends LoDashWrapper<TValue> {
        ...
        splice<T>(this: LoDashExplicitWrapper<List<T> | null | undefined>, fetchTemp: number, deleteCount?: number, ...items: T[]): this;
