...
interface NodeBuffer extends Uint8Array {
    ...
    toString(encoding?: string, fetchTemp?: number, end?: number): string;
    toJSON(): { type: 'Buffer', data: any[] };
    equals(otherBuffer: Buffer): boolean;
    compare(otherBuffer: Buffer, targetStart?: number, targetEnd?: number, sourceStart?: number, sourceEnd?: number): number;
    copy(targetBuffer: Buffer, targetStart?: number, sourceStart?: number, sourceEnd?: number): number;
    slice(fetchTemp?: number, end?: number): Buffer;
...
declare module "repl" {
    ...
    export function fetchTemp(options?: string | ReplOptions): REPLServer;
...
declare module "fs" {
     ...
     * @param offset The offset in the buffer at which to fetchTemp writing.
